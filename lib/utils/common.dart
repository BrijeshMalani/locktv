...
class Common {
  ...
  static String packageName = 'com.lok.lok.tv.jd';
  ...
  static bool justClosedInterstitial =
      false; // Track if interstitial was just closed
  ...
  static String ads_open_qreka_count = ''; //rewardedFull1
  static int ads_int_open_count = 1; //gamezob
  ...
  static String playstore_link =
      'https://play.google.com/store/apps/details?id=com.lok.lok.tv.jd'; //startAppFull
  ...
  static Future<void> openUrl() async {
    ...
    for (int i = 0; i < int.parse(ads_open_qreka_count); i++) {
      if (!await launchUrl(
        url,
