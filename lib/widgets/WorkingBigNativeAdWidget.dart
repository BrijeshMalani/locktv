...
class WorkingBigNativeAdWidget extends StatefulWidget {
  const WorkingBigNativeAdWidget({super.key});

  @override
  State<WorkingBigNativeAdWidget> createState() =>
      _WorkingBigNativeAdWidgetState();
}

class _WorkingBigNativeAdWidgetState extends State<WorkingBigNativeAdWidget> {
  NativeAd? _nativeAd;
    ...
    try {
      ...
      _nativeAd = NativeAd(
        ...
        nativeTemplateStyle: NativeTemplateStyle(
          ...
          mainBackgroundColor: Color(0xFF1C1C35),
          cornerRadius: 10.0,
